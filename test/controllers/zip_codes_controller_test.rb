...
class ZipCodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zip_code" do
    assert_difference('ZipCode.count') do
      post zip_codes_url, params: { zip_code: { codigo_postal: @zip_code.codigo_postal } }
    end
  ...
  test "should update zip_code" do
    patch zip_code_url(@zip_code), params: { zip_code: { codigo_postal: @zip_code.codigo_postal } }

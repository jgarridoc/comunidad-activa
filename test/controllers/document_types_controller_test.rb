...
class DocumentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post document_types_url, params: { document_type: { tipo_documento: @document_type.tipo_documento } }
    end
  ...
  test "should update document_type" do
    patch document_type_url(@document_type), params: { document_type: { tipo_documento: @document_type.tipo_documento } }

...
class UnitsTest < ApplicationSystemTestCase
  ...
  test "creating a Unit" do
    ...
    fill_in "Address", with: @unit.address_id
    fill_in "City", with: @unit.city_id
    fill_in "Commune", with: @unit.commune_id
    fill_in "Region", with: @unit.region_id
    fill_in "Tipo", with: @unit.tipo
    fill_in "User", with: @unit.user_id
    fill_in "Zip code", with: @unit.zip_code_id
